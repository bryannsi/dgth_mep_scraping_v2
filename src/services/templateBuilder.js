...
/**
 * Clase encargada exclusivamente de la construcción de representaciones visuales
 * (HTML, texto, etc.) de los datos de las vacantes.
 */
export class TemplateBuilder {
  /**
   * Crea una representación en tabla HTML (basada en tarjetas para mejor visualización móvil)
   * a partir de una lista de vacantes.
   * @param {Array} vacantes - Lista de vacantes a renderizar.
   * @returns {string} - Contenido HTML formateado.
   */
  static createHtmlTable(vacantes) {
