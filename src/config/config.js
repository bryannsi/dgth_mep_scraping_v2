...
const UNSUBSCRIBE_URL = getEnv("UNSUBSCRIBE_URL");
export const CONFIG = {
  isProd: isProd,
  baseHtml: `<!doctype html><html lang="es"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head><body style="margin:0;padding:0;font-family:'Segoe UI',Arial,sans-serif;color:#333"><table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding:20px"><tr><td align="center"><table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;background-color:transparent"><tr><td style="padding:10px 0 20px 0;text-align:left"><h2 style="margin:0;font-size:20px;color:#036">Oportunidades Disponibles</h2><p style="margin:5px 0 0 0;font-size:14px;color:#000">Hola <strong>{{NAME}}</strong>, estas son las vacantes según tu perfil:</p></td></tr><tr><td>{{TABLE}}</td></tr><tr><td style="padding:20px 0;border-top:1px solid #e1e8ed"><p style="margin:0;font-size:11px;color:#000;line-height:1.6;text-align:justify"><strong>Nota informativa:</strong> Este servicio de notificación es independiente y <strong>no tiene vínculo oficial con el Ministerio de Educación Pública (MEP)</strong>. Los datos mostrados son de carácter público y se entregan de forma automatizada a solicitud del usuario.</p><div style="margin-top: 20px; border-top: 1px solid #eee; padding-top: 10px; font-family: sans-serif; font-size: 12px; color: #777;"><p>Estás recibiendo este correo porque te suscribiste a las alertas de vacantes del MEP.</p><p>Si deseas dejar de recibir estos correos, haz clic en <a href="mailto:${UNSUBSCRIBE_URL}" style="color:#007bff;text-decoration:none;">este enlace para cancelar tu suscripción</a>.</p></div></td></tr></table></td></tr></table></body></html>`,
  scraper: {
  ...
  mail: {
    ...
    headers: {
      "List-Unsubscribe": `<mailto:${UNSUBSCRIBE_URL}>`,
